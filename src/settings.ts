...
export const settingsSchema: SettingSchemaDesc[] = [
  ...
  },
  {
    ...
    default: false,
    title: "Debug Mode",
    description: "Enable debug logging to see detailed asset resolution information in the browser console",
  },
];
...
export function getExportSettings(): ExportSettings {
  ...
  return {
    includePageName: settings["includePageName"] !== undefined ? Boolean(settings["includePageName"]) : false,
    flattenNested: settings["flattenNested"] !== undefined ? Boolean(settings["flattenNested"]) : true,
    preserveBlockRefs: settings["preserveBlockRefs"] !== undefined ? Boolean(settings["preserveBlockRefs"]) : true,
    includeProperties: settings["includeProperties"] !== undefined ? Boolean(settings["includeProperties"]) : true,
