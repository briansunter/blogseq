...
declare global {
  const logseq: {
    Editor: {
      ...
      getPage: Mock<
        [uuid: string | number | PageIdentity, opts?: Partial<{ includeChildren: boolean }>],
        Promise<PageEntity | null>
      >;
      getBlock: Mock<
        [uuid: string | number | BlockIdentity, opts?: Partial<{ includeChildren: boolean }>],
    ...
    UI: {
      showMsg: Mock<
        [content: string, status?: string, opts?: Partial<UIMsgOptions>],
        Promise<string>
      >;
    };
  };
