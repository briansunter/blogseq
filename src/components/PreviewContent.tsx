...
export const PreviewContent: React.FC<PreviewContentProps> = ({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-6 pt-8 pb-12 prose prose-sm prose-invert
      ...
      <ReactMarkdown
        ...
        components={{
          ...
          h1: ({...props}) => (
            <h1 {...props} className="text-2xl font-light mb-4 mt-6 text-gray-100 border-b border-gray-800 pb-2" />
          ),
          h2: ({...props}) => (
          ...
          h6: ({...props}) => (
            <h6 {...props} className="text-xs font-medium mb-1 mt-2 text-gray-300 uppercase tracking-wide" />
          ),
          p: ({...props}) => (
          ...
          blockquote: ({...props}) => (
            <blockquote {...props} className="border-l-3 border-blue-500/40 bg-blue-500/10 pl-3 pr-2 py-2 my-3 text-gray-300 italic text-sm" />
          ),
          hr: ({...props}) => (
          ...
          code: ({children, ...props}) => {
            ...
            return isInline ? (
              <code {...props} className="bg-gray-800/60 px-1 py-0.5 rounded text-xs font-mono text-blue-300">{children}</code>
            ) : (
              <code {...props} className="block bg-gray-900/60 border border-gray-800 p-3 rounded overflow-x-auto font-mono text-xs text-gray-300 leading-5 my-3">{children}</code>
            );
          },
        }}
      >
